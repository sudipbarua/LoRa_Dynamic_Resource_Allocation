...
def main(args):
    ...
    assert algo in ["exp3", "exp3s", "DDQN_ARA", "DDQN_LORADRL", "QL_ARA", "DQN_ARA", "DDQN_sysOptim"], "Learning algorithm must be exp3, exp3s, DDQN_ARA, DDQN_LORADRL, QL_ARA, DDQN_sysOptim"
...
if __name__ == '__main__':
    ...
    args = SimpleNamespace(
        ...
        Algo='DDQN_sysOptim',  # exp3, exp3s, DDQN_LORADRL, DDQN_ARA, QL_ARA, DQN_ARA, DDQN_sysOptim
        exp_name='DDQN_sysOptim_test',
